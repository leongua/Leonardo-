...
| Comando | Icona | Descrizione |
|---------|-------|-------------|
| `c:aama` | ![AAMA.BMP](INSTALLAZIONE/menu/LEONARDO/AAMA.BMP) | **Processore principale AAMA**. Workflow tecnico:<br>1. Seleziona polilinee  Esporta in DXF includendo tutti i layer (1, 11, 201, 202, 100, 90, 91) |
